...
void Game::Init()
{
	...
	m_mat->setAmbientIntensity(1.0f);
	m_mat->setAmbientColor(new AGR::ImageSampler("earth.png"));
	...
	m_scene = new AGR::Renderer(*m_cam, 0x0000FF00, glm::vec2(screen->GetWidth(), screen->GetHeight()));
